...
See the [releases page](https://github.com/earnestt1234/SipperViz/releases) to get the latest version of SipperViz.  The [`Installation.md`](dead-link) file has instructions on how to run SipperViz as either an executable or a Python script.
